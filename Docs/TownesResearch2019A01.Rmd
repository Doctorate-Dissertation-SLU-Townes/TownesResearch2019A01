...
jpg(filename = here("Results","MultRegres01ModelResidualsPlotA.jpg"))
CRECEIVEresid <- residuals(CRECEIVEregression)
plot(CRECEIVEresid)
dev.off()
...
jpg(filename = here("Results", "MultRegres01ModelResidualsDistribution.jpg"))
par(mfrow=c(2,2)) # set 2 rows and 2 column layout for plot
plot(CRECEIVEregression)
dev.off()
...
CRECEIVEresidTrfm <- residuals(CRECEIVEregressionTrfm)
jpg(filename = here("Results","MultRegresTrfmModelResidualsPlotA.jpg"))
plot(CRECEIVEresidTrfm)
dev.off()
...
jpg(filename = here("Results", "MultRegresTrfmModelResidualsDistribution.jpg"))
par(mfrow=c(2,2)) # set 2 rows and 2 column layout for plot
plot(CRECEIVEregressionTrfm)
dev.off()
