...
# Check that the variability in independent variable values is positive
varGYEAR <- var(Sample90to95D$GYEAR)
print(varGYEAR)

varCAT02 <- var(Sample90to95D$CAT02)
print(varCAT02)

varCAT03 <- var(Sample90to95D$CAT03)
print(varCAT03)

varCAT04 <- var(Sample90to95D$CAT04)
print(varCAT04)

varCAT05 <- var(Sample90to95D$CAT05)
print(varCAT05)

varCAT06 <- var(Sample90to95D$CAT06)
print(varCAT06)

varCLAIMS <- var(Sample90to95D$CLAIMS)
print(varCLAIMS)

varCMADE <- var(Sample90to95D$CMADE)
print(varCMADE)

varGENERAL <- var(Sample90to95D$GENERAL)
print(varGENERAL)

varORIGINAL <- var(Sample90to95D$ORIGINAL)
print(varORIGINAL)

varFWDAPLAG <- var(Sample90to95D$FWDAPLAG)
print(varFWDAPLAG)

varBCKGTLAG <- var(Sample90to95D$BCKGTLAG)
print(varBCKGTLAG)
