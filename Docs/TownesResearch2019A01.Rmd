...
# Residuals
CRECEIVEresid <- resid(CRECEIVEregression)
png(filename = here("Results","ResidualsBase.png"))
plot(Sample90to95C$ORIGINAL,CRECEIVEresid, ylab = "Residuals", xlab = ORIGINAL, main = "Citations Received - Regression with Untransformed Variables")
abline(0,0)
dev.off()
```
