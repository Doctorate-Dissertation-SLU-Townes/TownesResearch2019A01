...
#tvalues <- summary(CRECEIVEordinal$coefficients)
#coefsOrdinal <- coef(summary(CRECEIVEordinal))
#pvalues <- pt(abs(coefsOrdinal)[,"t value"],df.residuals(CRECEIVEordinal),lower.tail = FALSE)*2
#coefsOrdinal <- cbind(coefsOrdinal, "p values" = round(pvalues, 3))

# Calculate p-values for each variable
#pGYEAR <- pt(3750.5274, 1998-18, lower.tail = FALSE)*2
#pCAT02 <- pt(8.4527, 1998-18, lower.tail = FALSE)*2
#pCAT03 <- pt(8.4802, 1998-18, lower.tail = FALSE)*2
#pCAT04 <- pt(5.4347, 1998-18, lower.tail = FALSE)*2
#pCAT05 <- pt(0.3861, 1998-18, lower.tail = FALSE)*2
#pCAT06 <- pt(3.2922, 1998-18, lower.tail = FALSE)*2
#pCMADE <- pt(4.8389, 1998-18, lower.tail = FALSE)*2
#pCLAIMS <- pt(3.8649, 1998-18, lower.tail = FALSE)*2
#pORIGINAL <- pt(6.8949, 1998-18, lower.tail = FALSE)*2
#pGENERAL <- pt(68.3507, 1998-18, lower.tail = FALSE)*2
#pFWDAPLAG <- pt(24.3722, 1998-18, lower.tail = FALSE)*2
#pBCKGTLAG <- pt(2.0599, 1998-18, lower.tail = FALSE)*2
```
...
CRECregsubsets <- regsubsets(CRECEIVE ~ GYEAR + as.factor(CAT) + CMADE + CLAIMS + ORIGINAL + GENERAL + FWDAPLAG + BCKGTLAG, data = Sample90to95C, nbest = 10, method = "exhaustive")
...
# Regression
CRECEIVEregression <- lm(CRECEIVE ~ GYEAR + as.factor(CAT) + CMADE + CLAIMS + ORIGINAL + GENERAL + FWDAPLAG + BCKGTLAG, data = Sample90to95C, na.action = na.omit)
...
CorrCMADE <- cor.test(Sample90to95C$CMADE, CRECEIVEregression$residuals)
summary(CorrCMADE)
...
CorrBCKGTLAG <- cor.test(Sample90to95C$BCKGTLAG, CRECEIVEregression$residuals)
summary(CorrBCKGTLAG)
