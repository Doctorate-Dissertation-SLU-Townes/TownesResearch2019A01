...
ggsave(here("results", "histograms.png"), dpi = 300)
```
...
qqline(Sample90to95$CRECEIVE, col = "green", lwd = 2)
ggsave(here("results", "QQplotAPPYEAR"), dpi = 300)
...
qqline(Sample90to95$CRECEIVE, col = "green", lwd = 2)
ggsave(here("results", "QQplotCAT"), dpi = 300)
...
qqline(Sample90to95$CRECEIVE, col = "green", lwd = 2)
ggsave(here("results", "QQplotCMADE"), dpi = 300)
...
qqline(Sample90to95$CRECEIVE, col = "green", lwd = 2)
ggsave(here("results", "QQplotCLAIMS"), dpi = 300)
...
qqline(Sample90to95$CRECEIVE, col = "green", lwd = 2)
ggsave(here("results", "QQplotORIGINAL"), dpi = 300)
...
qqline(Sample90to95$CRECEIVE, col = "green", lwd = 2)
ggsave(here("results", "QQplotGENERAL"), dpi = 300)
...
qqline(Sample90to95$CRECEIVE, col = "green", lwd = 2)
ggsave(here("results", "QQplotRATIOCIT"), dpi = 300)

multiplot(QQplotCRECEIVE, QQplotCMADE, QQplotCLAIMS, QQplotORIGINAL, QQplotGENERAL, QQplotRATIOCIT, cols = 2)
ggsave(here("results", "QQplots.png"), dpi = 300)
```
...
logitCRECEIVE <- glm(CRECbinomial ~ APPYEAR + CAT + CMADE + CLAIMS + ORIGINAL + GENERAL + RATIOCIT, 
                     data = Sample90to95, family = binomial)
...
ordinalCRECEIVE <- polr(CRECEIVE ~ APPYEAR + CAT + CMADE + CLAIMS + ORIGINAL + GENERAL + RATIOCIT, 
                        data = Sample90to95, Hess = TRUE, model = TRUE, method = "logistic")
summary(ordinalCRECEIVE)
```
