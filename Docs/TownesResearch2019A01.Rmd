...
png(filename = here("Results", "QQplot.png"))
qqnorm(CRECEIVEresid, pch = 1, frame = FALSE, 
       main = "Normal Q-Q Plot for Base Level Regression", xlab = "Theoretical Quantiles", ylab = "Sample Quantiles")
qqline(CRECEIVEresid, col = "green", lwd = 2)
dev.off()

# Plots of Residuals by Independent Variables
png(filename = here("Results","ResidualsBase.png"))
