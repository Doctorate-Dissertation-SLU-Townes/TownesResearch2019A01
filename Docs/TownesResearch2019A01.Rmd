...
ggsave(here("results", "scatterCMADEbyCRECEIVE.png"), dpi = 300)

ggplot() +
  geom_point(Sample90to95, mapping = aes(x = CLAIMS, y = CRECEIVE))
ggsave(here("results", "scatterCLAIMSbyCRECEIVE.png"), dpi = 300)

ggplot() +
  geom_point(Sample90to95, mapping = aes(x = ORIGINAL, y = CRECEIVE))
ggsave(here("results", "scatterORIGINALbyCRECEIVE.png"), dpi = 300)

ggplot() +
  geom_point(Sample90to95, mapping = aes(x = GENERAL, y = CRECEIVE))
ggsave(here("results", "scatterGENERALbyCRECEIVE.png"), dpi = 300)

ggplot() +
  geom_point(Sample90to95, mapping = aes(x = RATIOCIT, y = CRECEIVE))
ggsave(here("results", "scatterRATIOCITbyCRECEIVE.png"), dpi = 300)
```
