...
The following code chunk performs a multiple logistic regression analysis on the data sample using the untransformed variables with `CRECEIVE` as the dependent variable to establish a baseline. It then displays the results. Next it plots the residuals and creates a `png` file of the residuals plot.
